...
made for the vault layer (see [site-plan](https://github.com/mdy-docs/mdy-docs/blob/main/docs/site-plan.md#mdy-docsvault-moved-directly-into-mdy-docs)).
...
([the package](../README.md)). The exit
